...
#define LP_OPTIONS16 (LP_OPTIONS | NAND_BUSWIDTH_16)
	...
	/* 1 Gigabit */
    /* edwardwan 20071226 add for vt3400 */
// 	{"NAND 128MiB 3,3V 8-bit",	0xAD, 2048, 128, 1<<17, 0},
...
struct WMT_nand_flash_dev WMT_nand_flash_ids[] = {
  ...
  {0x98D585A5, 8192, 2048, 16, 262144, 5, 0, 127, 0, WIDTH_8,
   1, 0, 1, NAND_TYPE_MLC, 4, 0, 0x2424, "TOSHIBA_NF_TH58NVG4D4C"},*/
	...
	{0xEC75A5BD, 2048,  512,  16,  0x4000, 4,   0,   1, 5, WIDTH_8, 1, 1, 0, NAND_TYPE_SLC,  1, 0x230F1964, "K95608U0D", LP_OPTIONS},

	{0x98D594BA, 4096, 4096, 218, 0x80000, 5,   0, 127, 0, WIDTH_8, 1, 0, 1, NAND_TYPE_MLC, 12,0x190F0F70, "TC58NVG4D1DTG0", LP_OPTIONS},
	{0xECDC1425, 2048, 2048, 64, 262144,5,   127,   127, 0, WIDTH_8, 4, 0, 1, NAND_TYPE_MLC, 4, 0x140A0F64, "SAMSUNG_K9G4G08U0A", LP_OPTIONS},
	{0xADD514B6, 4096, 4096, 128, 512*1024,5,  127,   125, 0, WIDTH_8, 4, 0, 1, NAND_TYPE_MLC,  4, 0x140A0C64, "HYNIX_H27UAG8T2M", LP_OPTIONS},
	{0xECD514B6, 4096, 4096, 128, 512*1024, 5, 127, 127, 0, WIDTH_8, 1, 0, 1, NAND_TYPE_MLC, 4, 0x140A0C64,"SAMSUNG_K9XXG08UXM", LP_OPTIONS},	  /*just check for K9GAG08U0M*/
	{0x20D59425, 4096, 4096, 218, 524288, 5, 127, 125, 0, WIDTH_8, 1, 0, 1, NAND_TYPE_MLC,  12, 0x140A0F64,"HYNIX_H27UAG8T2ATR", LP_OPTIONS}, //1page=(4k+224)bytes,1block=128pages,1device=4096blocks)
	{0xADDC8095, 4096, 2048, 64 , 131072 , 5,    0,     1, 0, WIDTH_8, 4, 0, 1, NAND_TYPE_SLC,    1, 0x190A0F64, "HYNIX_HY27UF084G2M", LP_OPTIONS},
        {0xADDC14A5, 2048, 2048, 64,  262144,  5, 127, 125, 0, WIDTH_8, 1, 0, 1, NAND_TYPE_MLC,   4, 0x140A0C64,  "HYNIX_H27U4G8T2B", LP_OPTIONS}, //1page=(2k+64)bytes,1block=128pages,1device=2048blocks)
	{0,}
