 ...
 * Status Registers
 */
#define VT8500_NFC_DATAPORT	              0x00

/*
 * Control Registers
 */
#define VT8500_NFC_COMCTRL	              0x04
#define VT8500_NFC_COMPORT0	              0x08
#define VT8500_NFC_COMPORT1_2	              0x0c
#define VT8500_NFC_COMPORT3_4	              0x10
#define VT8500_NFC_COMPORT5_6	              0x14
#define VT8500_NFC_COMPORT7	              0x18
#define VT8500_NFC_COMPORT8_9                 0x1c
#define VT8500_NFC_DMA_COUNTER	              0x20
#define VT8500_NFC_SMC_ENABLE	              0x24

/*
 * Status Registers
 */
#define VT8500_NFC_MISC_STAT_PORT             0x28

/*
 *  Status Control Registers
 */
#define VT8500_NFC_HOST_STAT_CHANGE           0x2c

/*
 * Control Registers
 */
#define VT8500_NFC_SMC_DMA_COUNTER            0x30
#define VT8500_NFC_CALC_CTRL                  0x34
#define VT8500_NFC_CALC_NUM	                  0x38
#define VT8500_NFC_CALC_NUM_QU	              0x3c
#define VT8500_NFC_REMAINDER	                0x40
#define VT8500_NFC_CHIP_ENABLE_CTRL           0x44
#define VT8500_NFC_NAND_TYPE_SEL              0x48
#define VT8500_NFC_REDUNT_ECC_STAT_MASK	      0x4c
#define VT8500_NFC_READ_CYCLE_PULE_CTRL	      0x50
#define VT8500_NFC_MISC_CTRL	                0x54
#define VT8500_NFC_DUMMY_CTRL	                0x58
#define VT8500_NFC_PAGESIZE_DIVIDER_SEL	      0x5c
#define VT8500_NFC_RW_STROBE_TUNE	            0x60
#define VT8500_NFC_BANK18_ECC_STAT_MASK       0x64

/*
 * Status Registers
 */
#define VT8500_NFC_ODD_BANK_PARITY_STAT	      0x68
#define VT8500_NFC_EVEN_BANK_PARITY_STAT      0x6c
#define VT8500_NFC_REDUNT_AREA_PARITY_STAT    0x70
#define VT8500_NFC_IDLE_STAT	                0x74
#define VT8500_NFC_PHYS_ADDR	                0x78

/*
 *  Status Control Registers
 */
#define VT8500_NFC_REDUNT_ECC_STAT	          0x7c
#define VT8500_NFC_BANK18_ECC_STAT	          0x80

/*
 * Control Registers
 */
#define VT8500_NFC_TIMER_COUNTER_CONFIG       0x84
#define VT8500_NFC_NANDFLASH_BOOT	            0x88
#define VT8500_NFC_ECC_BCH_CTRL	              0x8c
#define VT8500_NFC_ECC_BCH_INT_MASK	          0x90

/*
 *  Status Control Registers
 */
#define VT8500_NFC_ECC_BCH_INT_STAT1          0x94

/*
 * Status Registers
 */
#define VT8500_NFC_ECC_BCH_INT_STAT2          0x98
#define VT8500_NFC_ECC_BCH_ERR_POS1	          0x9c
#define VT8500_NFC_ECC_BCH_ERR_POS2	          0xa0
#define VT8500_NFC_ECC_BCH_ERR_POS3	      		0xa4
#define VT8500_NFC_ECC_BCH_ERR_POS4	          0xa8
#define VT8500_NFC_ECC_BCH_ERR_POS5	          0xac
#define VT8500_NFC_ECC_BCH_ERR_POS6	          0xb0
#define VT8500_NFC_ECC_BCH_ERR_POS7	          0xb4
#define VT8500_NFC_ECC_BCH_ERR_POS8	          0xb8
