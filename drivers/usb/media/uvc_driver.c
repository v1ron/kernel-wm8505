...
#include "uvcvideo.h"
/* ------------------------------------------------------------------------
 * Charles,2009.02.20, removed version.h for kernel feature real time preemption. 
 * Due to it cause compiler error.
 */
/* #include "version.h"   */
...
static int uvc_register_video(struct uvc_device *dev)
{
	...
	if (vdev == NULL)
		return -1;
// HP_02/22/2008 - product is added in later version of kernel
...
static int uvc_suspend(struct usb_interface *intf, u32 message)
{
	struct uvc_device *dev = usb_get_intfdata(intf);
