...
/*--- History ------------------------------------------------------------------- 
* Version 0.01 , Sam Shen, 2009/03/30
*           First version
*
*------------------------------------------------------------------------------*/
...
disp_attr_t disp_attr_tbl[8]={
	...
	/*P_PYAF*/ 0x9e, /*P_PBAF*/ 0xa0, /*P_PRAF*/ 0xa0,
	...
	/*P_PYAF*/ 0x9a, /*P_PBAF*/ 0x9d, /*P_PRAF*/ 0xa0,
...
disp_timing_t disp_timing_tbl[6] = {
	{	// NTSC-I
...
disp_timing_t *disp_get_timing(vpp_flag_t ntsc,vpp_flag_t interlace,vpp_flag_t ext)
{
	int type;
