...
/*--- History ------------------------------------------------------------------- 
* Version 0.01 , Sam Shen, 2008/12/23
*           First version
*
*------------------------------------------------------------------------------*/
...
)
{
	...
	DPRINTK("Enter vfb_check_var\n");

	DPRINTK("src-xres:%d,yres:%d\n", var->xres,var->yres);

	DPRINTK("dest-xres:%d,yres:%d\n", var->xres,var->yres);
...
static struct device_driver vfb_driver = {
	.name           = "wmvfb", // This name should equal to platform device name.
