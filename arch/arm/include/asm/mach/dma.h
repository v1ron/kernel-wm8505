...
#define SPI_8BITS_SETTING          (DMA_WRAP_1 | DMA_BURST_1 | DMA_SIZE_8 | DMA_UP_MEMREG_EN) /*there is porblem about burst 8*/
#define SPI_16BITS_SETTING         (DMA_WRAP_1 | DMA_BURST_8 | DMA_SIZE_16 | DMA_UP_MEMREG_EN)
#define SPI_32BITS_SETTING         (DMA_WRAP_1 | DMA_BURST_8 | DMA_SIZE_32 | DMA_UP_MEMREG_EN)
...
#define SPI2_TX_FIFO 0xD82A0010
#define SPI2_RX_FIFO 0xD82A0030 
...
#define UART_8BITS_SETTING          (DMA_WRAP_1 | DMA_BURST_1 | DMA_SIZE_8 | DMA_UP_MEMREG_EN)
#define UART_16BITS_SETTING         (DMA_WRAP_1 | DMA_BURST_1 | DMA_SIZE_16 | DMA_UP_MEMREG_EN)
#define UART_32BITS_SETTING         (DMA_WRAP_1 | DMA_BURST_1 | DMA_SIZE_32 | DMA_UP_MEMREG_EN)
...
#define UART0_TX_FIFO (0x1000+UART1_BASE_ADDR)
#define UART0_RX_FIFO (0x1020+UART1_BASE_ADDR)

#define UART1_TX_FIFO (0x1000+UART2_BASE_ADDR)
#define UART1_RX_FIFO (0x1020+UART2_BASE_ADDR)

#define UART2_TX_FIFO (0x1000+UART3_BASE_ADDR)
#define UART2_RX_FIFO (0x1020+UART3_BASE_ADDR)

#define UART3_TX_FIFO (0x1000+UART4_BASE_ADDR)
#define UART3_RX_FIFO (0x1020+UART4_BASE_ADDR)

#define UART4_TX_FIFO (0x1000+UART5_BASE_ADDR)
#define UART4_RX_FIFO (0x1020+UART5_BASE_ADDR)

#define UART5_TX_FIFO (0x1000+UART6_BASE_ADDR)
#define UART5_RX_FIFO (0x1020+UART6_BASE_ADDR) 
