...
#error "You must include hardware.h, not wm8510_intc.h"
#endif
...
/******************************************************************************
 *
 * WM8510 Interrupt Controller Base Address.
 *
 ******************************************************************************/
#ifdef __IC_BASE
#error  "__IC_BASE has already been defined in another file."
#endif
#ifdef INTERRUPT_CTRL_BASE_ADDR        /* From wm8510.mmap.h */
#define __IC_BASE       INTERRUPT_CTRL_BASE_ADDR
#else
#define __IC_BASE       0xD8140000      /* 64K */
#endif

#ifdef INTERRUPT1_CTRL_BASE_ADDR        /* From wm8510.mmap.h */
#define __IC1_BASE       INTERRUPT1_CTRL_BASE_ADDR
#else
#define __IC1_BASE       0xD8150000      /* 64K */
#endif
/******************************************************************************
 *
 * WM8510 Interrupt Controller (IC) control registers.
 *
...
#define ICDC_NUM_WM8510        0x80           /* dest_ctl registers number = 64 WM8510 */
#define ICDC_NUMMASK_WM8510    0x7F           /* mask to avoid overflow WM8510 */
#define ICDC_OFFSET_WM8510(x)  ((x) & ICDC_NUMMASK_WM8510)                     /* address offset WM8510 */
#define ICDC0_REG(x)     (REG8_PTR(ICDC0_ADDR + ICDC_OFFSET_WM8510(x)))        /* 0 to 63 WM8510 */
#define ICDC0_VAL(x)     (REG8_VAL(ICDC0_ADDR + ICDC_OFFSET_WM8510(x)))        /* 0 to 63 WM8510 */
#define ICDC1_REG(x)     (REG8_PTR(__IC1_BASE + 0x40 + ICDC_OFFSET_WM8510(x))) /* 0 to 63 WM8510 */
#define ICDC1_VAL(x)     (REG8_VAL(__IC1_BASE + 0x40 + ICDC_OFFSET_WM8510(x))) /* 0 to 63 WM8510 */
