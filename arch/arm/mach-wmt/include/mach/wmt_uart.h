...
#ifndef __VT8500_UART_H
#define __VT8500_UART_H
...
/*
 *   UART 1 : System Debug RS-232 (DB-9)
 */
...
/*
 *   UART 3 : External DB-9 connector
 */
 ...
 *   UART 6 : IR Sensor
 */
#define UART6_URTDR_ADDR    (UART6_BASE_ADDR + 0x0000)
#define UART6_URRDR_ADDR    (UART6_BASE_ADDR + 0x0004)
#define UART6_URBRD_ADDR    (UART6_BASE_ADDR + 0x0008)
#define UART6_URLCR_ADDR    (UART6_BASE_ADDR + 0x000C)
#define UART6_URICR_ADDR    (UART6_BASE_ADDR + 0x0010)
#define UART6_URIER_ADDR    (UART6_BASE_ADDR + 0x0014)
#define UART6_URISR_ADDR    (UART6_BASE_ADDR + 0x0018)
#define UART6_URUSR_ADDR    (UART6_BASE_ADDR + 0x001C)
#define UART6_URFCR_ADDR    (UART6_BASE_ADDR + 0x0020)
#define UART6_URFIDX_ADDR   (UART6_BASE_ADDR + 0x0024)
#define UART6_URBKR_ADDR    (UART6_BASE_ADDR + 0x0028)
#define UART6_URDIV_ADDR    (UART6_BASE_ADDR + 0x002C)
#define UART6_URTXF_ADDR    (UART6_BASE_ADDR + 0x0030)
#define UART6_URRXF_ADDR    (UART6_BASE_ADDR + 0x0040)

#define UART6_URTDR_REG     REG32_PTR(UART6_URTDR_ADDR)     /* RW, Transmit data register */
#define UART6_URRDR_REG     REG32_PTR(UART6_URRDR_ADDR)     /* RO, Receive data register */
#define UART6_URBRD_REG     REG32_PTR(UART6_URBRD_ADDR)     /* RW, Baud rate divisor */
#define UART6_URLCR_REG     REG32_PTR(UART6_URLCR_ADDR)     /* RW, Line control register */
#define UART6_URICR_REG     REG32_PTR(UART6_URICR_ADDR)     /* RW, IrDA control register */
#define UART6_URIER_REG     REG32_PTR(UART6_URIER_ADDR)     /* RW, Interrupt enable register */
#define UART6_URISR_REG     REG32_PTR(UART6_URISR_ADDR)     /* RO, Interrupt status register */
#define UART6_URUSR_REG     REG32_PTR(UART6_URUSR_ADDR)     /* RO, UART status register */
#define UART6_URFCR_REG     REG32_PTR(UART6_URFCR_ADDR)     /* RW, FIFO control register */
#define UART6_URFIDX_REG    REG32_PTR(UART6_URFIDX_ADDR)    /* RO, FIFO index register */
#define UART6_URDIV_REG     REG32_PTR(UART6_URDIV_ADDR)     /* WR, UART clock divisor Register */
#define UART6_URBKR_REG     REG32_PTR(UART6_URBKR_ADDR)     /* RW, Break count-value register */

#define UART6_URTDR_VAL     REG32_VAL(UART6_URTDR_ADDR)
#define UART6_URRDR_VAL     REG32_VAL(UART6_URRDR_ADDR)
#define UART6_URBRD_VAL     REG32_VAL(UART6_URBRD_ADDR)
#define UART6_URLCR_VAL     REG32_VAL(UART6_URLCR_ADDR)
#define UART6_URICR_VAL     REG32_VAL(UART6_URICR_ADDR)
#define UART6_URIER_VAL     REG32_VAL(UART6_URIER_ADDR)
#define UART6_URISR_VAL     REG32_VAL(UART6_URISR_ADDR)
#define UART6_URUSR_VAL     REG32_VAL(UART6_URUSR_ADDR)
#define UART6_URFCR_VAL     REG32_VAL(UART6_URFCR_ADDR)
#define UART6_URFIDX_VAL    REG32_VAL(UART6_URFIDX_ADDR)
#define UART6_URDIV_VAL     REG32_VAL(UART6_URDIV_ADDR)
#define UART6_URBKR_VAL     REG32_VAL(UART6_URBKR_ADDR)
