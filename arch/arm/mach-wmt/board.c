...
static void __init wmt_map_io(void)
{
    ...
    wmt_register_uart(0, 1);	/* mount ttyS0 (or ttyVT0) to UART0*/
    wmt_register_uart(1, 2);	/* mount ttyS1 to UART1*/
    wmt_register_uart(2, 3);	/* mount ttyS2 to UART2*/
    wmt_register_uart(3, 4);	/* mount ttyS3 to UART3*/
    wmt_register_uart(4, 5);	/* mount ttyS4 to UART4*/
    wmt_register_uart(5, 6);	/* mount ttyS5 to UART5*/
}
