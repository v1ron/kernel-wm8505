/*
	...
	2009/01/12 Created by Dean Hsiao

	2009/02/25 DM4 driver has just supported peripheral to memory and memory peripheral to memory
		it is necessary to support memory to memory support in the future. Dean.
...
struct dma_device_cfg_s dma_device_cfg_table[] = {
	...
	{ SPI2_DMA_TX_REQ , 0x00000100 , 0, 0 , SIZE_4KB},
	{ SPI2_DMA_RX_REQ , 0x00000100 , 0, 0 , SIZE_4KB},
	...
	{ I2S_TX_DMA_REQ, I2S_TX_DMA_CFG, 0, I2S_TX_FIFO , SIZE_16KB},
	{ I2S_RX_DMA_REQ, I2S_RX_DMA_CFG, 0, I2S_RX_FIFO , SIZE_16KB},
	/*start from 0, above 15, below 16 */
	{ UART_4_TX_DMA_REQ , UART_TX_DMA_CFG, 0, UART4_TX_FIFO , SIZE_1B},  /* uart4*/
	{ UART_4_RX_DMA_REQ , UART_RX_DMA_CFG, 0, UART4_RX_FIFO , SIZE_4KB},  /* uart4*/
	{ AC97_PCM_TX_DMA_REQ , AC97_PCM_TX_DMA_CFG, 0, AC97_TX_FIFO , SIZE_16KB},
	{ AC97_PCM_RX_DMA_REQ , AC97_PCM_RX_DMA_CFG, 0, AC97_RX_FIFO , SIZE_16KB},
	{ AC97_MIC_DMA_REQ , AC97_PCM_TX_DMA_CFG, 0, AC97_MIC_FIFO , SIZE_16KB},
	...
	{ DEVICE_RESERVED , 0x00000100, 0, 0 , SIZE_4KB},
	{ DEVICE_RESERVED , 0x00000100, 0, 0 , SIZE_4KB},
	{ UART_5_TX_DMA_REQ , UART_TX_DMA_CFG, 0, UART5_TX_FIFO , SIZE_1B},  /* uart5*/
	{ UART_5_RX_DMA_REQ , UART_RX_DMA_CFG, 0, UART5_RX_FIFO , SIZE_4KB},  /* uart5*/
...
wmt_dma_init(void)
{
	...
	dma_regs = (struct dma_regs_s *) (io_p2v(DMA_CTRL_CFG_BASE_ADDR)) ;
/*
	ret = sysdev_class_register(&vt8610_dma_sysclass);
	if (ret != 0) {
