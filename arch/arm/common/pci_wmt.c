...
void init_int_usb(void)
{
		...
		pci_config_shadow[INT_USB_EHCI][0][4] = 0xD8007100; /*  0xD8007200; for VT3358 */
		...
		pci_config_shadow[INT_USB_EHCI][0][0xF] = 0x0101;  /*  0x010B; for VT3358   */
		...
		pci_config_shadow[INT_USB_UHCI][0][8] = 0xD8007301; /*  0xD8007401; for VT3358 */
		...
		pci_config_shadow[INT_USB_UHCI][0][0xF] = 0x0100;   /*  0x010B; for VT3358  */
